import{t as i,a as t}from"../chunks/disclose-version.CRH15Tq2.js";import"../chunks/legacy.B7x09vCb.js";import{$ as n}from"../chunks/runtime.DeXpxtC2.js";import{h as l}from"../chunks/svelte-head.tW1tNO1N.js";import{a as e}from"../chunks/attributes.CaPm3nup.js";const h=""+new URL("../assets/intro.CSyXUABa.png",import.meta.url).href,c=""+new URL("../assets/rast.BuaQUlGH.png",import.meta.url).href,d=""+new URL("../assets/shad.UmFbctmw.png",import.meta.url).href;var p=i('<meta name="description" content="Learn how 3D rendering works, covering the key steps of Vertex Shading, Rasterisation, and Fragment Shading in the rendering pipeline.">'),m=i(`<main class="p-6 max-w-3xl mx-auto"><h1 class="text-4xl font-bold text-text my-4">How does a 3D renderer work?</h1> <section class="text-lg text-subtext1 mb-4"><p class="font-semibold">authors : Lucien VILLARD &amp; Corentin SOLOIS</p></section> <h2 id="overview" class="text-2xl font-bold text-text mb-2">Introduction</h2> <p class="text-lg text-subtext1 mb-1">3D is everywhere in our new technology. Think of film (animation, VFX),
    ...
    understand the basis of the 3D renderer.</p> <img${e("src",h)} alt="intro" class="w-full"> <h2 id="overview" class="text-2xl font-bold text-text mb-2 mt-8">Vertex Shading</h2> <p class="text-lg text-subtext1 mb-1">First of all, it is very important to understand how 3D models are
    ...
    position is projected onto the 2D screen.</p> <h2 id="overview" class="text-2xl font-bold text-text mb-2 mt-8">Rasterisation</h2> <p class="text-lg text-subtext1 mb-1">To continue, just remember that a screen is a grid of millions of pixels of
    ...
    displayed on screen.</p> <img${e("src",c)} alt="Rasterisation" class="w-full"> <h2 id="overview" class="text-2xl font-bold text-text mb-2 mt-8">Fragment Shading</h2> <p class="text-lg text-subtext1 mb-1">After the first two steps, we get a passable rendering, but there's no
    ...
    depending on its color, roughness (gloss) or refractive index.</p> <img${e("src",d)} alt="Fragment Shading" class="w-full"> <h2 id="overview" class="text-2xl font-bold text-text mb-2 mt-8">Conclusion</h2> <p class="text-lg text-subtext1 mb-1">This article is just an overview of the world of 3D rendering engines. We
    ...
    this field.</p> <section class="mt-8"><h2 class="text-2xl font-bold text-text mb-2">Sources</h2> <ul class="text-lg text-subtext1 list-disc ml-6"><li><a href="https://www.youtube.com/watch?v=C8YtdC8mxTU" class="text-blue hover:underline" target="_blank">How do Video Game Graphics Work?</a></li> <li><a href="https://en.wikipedia.org/wiki/Shader#Vertex_shaders" class="text-blue hover:underline" target="_blank">Vertex Shaders</a></li> <li><a href="https://en.wikipedia.org/wiki/Graphics_pipeline" class="text-blue hover:underline" target="_blank">Graphics Pipeline</a></li> <li><a href="https://en.wikipedia.org/wiki/3D_projection" class="text-blue hover:underline" target="_blank">3D projection</a></li> <li><a href="https://en.wikipedia.org/wiki/3D_rendering" class="text-blue hover:underline" target="_blank">3D Rendering</a></li></ul></section></main>`);function b(o){var a=m();l(r=>{var s=p();n.title="How does a 3D renderer work?",t(r,s)}),t(o,a)}export{b as component};
