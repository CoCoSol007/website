import{s as g,n}from"../chunks/scheduler.Cs0xm5t1.js";import{S as p,i as x,e as c,s as u,h as y,c as d,d as s,a as b,g as f,j as i,k as w,l as h}from"../chunks/index.odHI_-bW.js";const v=""+new URL("../assets/thal.BuX4MOe8.png",import.meta.url).href,_=""+new URL("../assets/pyth.DGBe7L1F.png",import.meta.url).href,D=""+new URL("../assets/conv.C7If6J2v.png",import.meta.url).href,T=""+new URL("../assets/conv3D.CdpsyQra.png",import.meta.url).href,C=""+new URL("../assets/dist.Dr7VrFg8.png",import.meta.url).href,k=""+new URL("../assets/example.DYCxmRux.mp4",import.meta.url).href;function R(m){let e,r,t,l=`<h1 id="my-own-3d-renderer" class="text-4xl font-bold text-gray-100 mb-4">My Own 3D Renderer</h1> <h1 id="overview" class="text-4xl font-bold text-gray-100 mb-2">Overview</h1> <p class="text-lg text-gray-300 mb-1">This is a basic 3D <strong class="font-bold">renderer</strong> created using
    <strong class="font-bold">Math</strong>.</p> <p class="text-lg text-gray-300 mb-4">link to the <a href="https://github.com/CoCoSol007/misc/tree/main/3DViewPy" class="text-blue-500 hover:underline">repository</a>.</p> <h2 id="basic-usage" class="text-2xl font-semibold text-gray-100 mb-2">Basic usage</h2> <p class="text-lg text-gray-300 mb-4">The basic use of my rendering engine:</p> <pre class="bg-gray-800 p-4 rounded overflow-x-auto text-gray-100 mb-4"><code class="code language-python">&quot;&quot;&quot;The main file of the 3D renderer&quot;&quot;&quot;
...
for x in range(0, 10):
    ...
    horizontally. For example:</p> <div class="relative mb-4"><video controls="" class="w-full h-auto rounded-lg shadow-md" alt="example"><track kind="captions"/><source src="${k}" type="video/mp4"/>
    ...
    using just two applications of Thales&#39; theorem.</p> <img class="mt-2 h-auto rounded mb-4" src="${T}" alt="3D renderer example"/> <p class="text-lg text-gray-300 mb-4">This method involves four key variables: \`x\`, \`y\`, \`z\`, and \`dist\`. The
    ...
    formulas:</p> <pre class="bg-gray-800 p-4 rounded overflow-x-auto text-gray-100 mb-4"><code class="code language-python">new_x = x * dist / z
new_y = y * dist / z</code></pre> <p class="text-lg text-gray-300 mb-4">To visualize this process differently, think of it as looking through a pane
    ...
    camera, the glass represents the 2D world, and what you observe is in 3D.</p> <p class="text-lg text-gray-300 mb-4">In other words, when you look through the glass, you perceive a
    ...
    simplifying its complexity into a 2D representation.</p> <h3 id="pythagoras" class="text-xl font-semibold text-gray-100 mb-2">Pythagoras</h3> <p class="text-lg text-gray-300 mb-4">The way I discovered how to view the 3D world on a 2D surface using the
    ...
    process into clear steps.</p> <ul class="list-disc list-inside text-lg text-gray-300 mb-4"><li><strong class="font-bold">Calculating the 3D Distance</strong>: Using the
      Pythagorean theorem to find the distance from a point to the camera.</li></ul> <img class="mt-2 h-auto rounded mb-4" src="${C}" alt="3D distance calculation"/> <ul class="list-disc list-inside text-lg text-gray-300 mb-4"><li><strong class="font-bold">Projecting into 2D</strong>: Normalizing the
      coordinates to convert them into a 2D view.</li></ul> <pre class="bg-gray-800 p-4 rounded overflow-x-auto text-gray-100 mb-4"><code class="code language-python">new_x = current_x / vector3D_pointToCam
new_y = current_y / vector3D_pointToCam</code></pre> <ul class="list-disc list-inside text-lg text-gray-300 mb-4"><li><strong class="font-bold">Transforming into Screen Coordinates</strong>:
      ...
      screen.</li></ul> <pre class="bg-gray-800 p-4 rounded overflow-x-auto text-gray-100 mb-4"><code class="code language-python">pygame.math.Vector2(new_x * 500 + width / 2, new_y * 500 + height / 2)</code></pre> <p class="text-lg text-gray-300 mb-4">This 3D rendering method has limitations because it inappropriately uses the
    ...
    if camera.view == ViewCamera.THALES:
        ...
        return pygame.math.Vector2(new_x * 500 + width / 2, new_y * 500 + height / 2)</code></pre> <h2 id="camera-movement" class="text-2xl font-semibold text-gray-100 mb-2">Camera Movement</h2> <p class="text-lg text-gray-300 mb-4">Camera movement is straightforward: you just need to save a 3D position and
    pass it as an argument to the <code class="code bg-gray-800 p-1 rounded">to_2d</code> function. To change the camera&#39;s position and update the view, simply modify
    the 3D point.</p> <h2 id="camera-rotation" class="text-2xl font-semibold text-gray-100 mb-2">Camera Rotation</h2> <p class="text-lg text-gray-300 mb-4">Later, after learning more about matrices, I was able to improve my code and
    add camera rotation to my renderer. Let me explain how it works:</p> <h3 class="text-xl font-semibold text-gray-100 mb-2">Creating Rotation Matrices</h3> <p class="text-lg text-gray-300 mb-4">The functions <code class="code bg-gray-800 p-1 rounded">rotation_matrix_x</code>
    ...
    if necessary.</p> <pre class="bg-gray-800 p-4 rounded overflow-x-auto text-gray-100 mb-4"><code class="code language-python">def rotation_matrix_x(theta):
    ...
    return np.array([
        ...
        [0, s, c, 0],
        [0, 0, 0, 1]
    ])</code></pre> <p class="text-lg text-gray-300 mb-4">Explanation:</p> <ul class="list-disc pl-6 text-gray-300 mb-4"><li><strong class="font-bold">c</strong> and
      <strong class="font-bold">s</strong>
      represent the cosine and sine of the angle
      <strong class="font-bold">theta</strong>, respectively.</li> <li>The returned matrix performs a rotation around the X axis.</li></ul> <h3 class="text-xl font-semibold text-gray-100 mb-2">Calculating the Final Rotation Matrix</h3> <p class="text-lg text-gray-300 mb-4">We calculate the final rotation matrix by combining rotations around the X
    and Y axes. The rotation matrices are multiplied in the order Y -&gt; X to
    obtain the final matrix.</p> <pre class="bg-gray-800 p-4 rounded overflow-x-auto text-gray-100 mb-4"><code class="code language-python">rotation_matrix = rotation_matrix_y(rotation_y) @ rotation_matrix_x(rotation_x)</code></pre> <p class="text-lg text-gray-300 mb-4">Explanation:</p> <ul class="list-disc pl-6 text-gray-300 mb-4"><li>The rotation matrices are multiplied in this order to apply the rotations
      in the correct sequence.</li></ul> <h3 class="text-xl font-semibold text-gray-100 mb-2">Creating the Camera Matrix</h3> <pre class="bg-gray-800 p-4 rounded overflow-x-auto text-gray-100 mb-4"><code class="code language-python">camera_position = np.array([camera_x, camera_y, camera_z])
camera_matrix = np.identity(4)
camera_matrix[:3, 3] = camera_position</code></pre> <h3 class="text-xl font-semibold text-gray-100 mb-2">Calculating the View Matrix</h3> <p class="text-lg text-gray-300 mb-4">The view matrix is created by combining the rotation matrix and the camera
    matrix. It represents the transformation needed to convert world coordinates
    to camera coordinates.</p> <pre class="bg-gray-800 p-4 rounded overflow-x-auto text-gray-100 mb-4"><code class="code language-python">view_matrix = rotation_matrix.copy()
view_matrix[:3, :3] = rotation_matrix[:3, :3]
view_matrix = view_matrix @ camera_matrix</code></pre> <p class="text-lg text-gray-300 mb-4">Explanation:</p> <ul class="list-disc pl-6 text-gray-300 mb-4"><li>We copy the rotation matrix and multiply it by the camera matrix to get
      the view matrix.</li></ul> <h3 class="text-xl font-semibold text-gray-100 mb-2">Transforming the 3D Point</h3> <p class="text-lg text-gray-300 mb-4">The 3D point is transformed by applying the view matrix. This adjusts the
    point based on the defined rotations and translations, giving the new
    position of the point from the camera&#39;s perspective.</p> <pre class="bg-gray-800 p-4 rounded overflow-x-auto text-gray-100 mb-4"><code class="code language-python">point_3d = np.array([point_x, point_y, point_z, 1])
transformed_point = view_matrix @ point_3d</code></pre> <p class="text-lg text-gray-300 mb-4">Explanation:</p> <ul class="list-disc pl-6 text-gray-300 mb-4"><li>We add a homogeneous component (1) to the 3D point to use 4x4 matrix
      multiplication.</li> <li>The point is transformed by multiplying it with the view matrix.</li></ul> <h3 class="text-xl font-semibold text-gray-100 mb-2">Rendering the Point</h3> <p class="text-lg text-gray-300 mb-4">After obtaining the new position of the point based on the camera&#39;s
    rotation, we can project it using the <code class="code bg-gray-800 p-1 rounded">to_2d</code> function.</p> <h2 id="limitations-and-improvements" class="text-2xl font-semibold text-gray-100 mb-2">Limitations and Improvements</h2> <h3 class="text-xl font-semibold text-gray-100 mb-2">Z Buffer</h3> <p class="text-lg text-gray-300 mb-4">One significant limitation of this simple renderer is the absence of a <strong class="font-bold">Z-buffer</strong>. The Z-buffer, or depth buffer, is a crucial component in 3D rendering
    ...
    rendering. For example, with this great <a href="https://youtu.be/qSrGbVxCYeo?si=2ufH6zUgWBgM7G5V" class="text-blue-400 hover:underline">documentation video</a>.</p>`;return{c(){e=c("meta"),r=u(),t=c("main"),t.innerHTML=l,this.h()},l(a){const o=y("svelte-14ys5by",document.head);e=d(o,"META",{name:!0,content:!0}),o.forEach(s),r=b(a),t=d(a,"MAIN",{class:!0,"data-svelte-h":!0}),f(t)!=="svelte-1uw2l2f"&&(t.innerHTML=l),this.h()},h(){document.title="My Own 3D Renderer",i(e,"name","description"),i(e,"content","Learn how to build a basic 3D renderer using math concepts such as Pythagorean and Thales' theorem. This article covers basic usage, mesh creation, camera movement, rotation, and the math behind rendering 3D objects to a 2D plane."),i(t,"class","p-6 max-w-3xl mx-auto")},m(a,o){w(document.head,e),h(a,r,o),h(a,t,o)},p:n,i:n,o:n,d(a){a&&(s(r),s(t)),s(e)}}}class I extends p{constructor(e){super(),x(this,e,null,R,g,{})}}export{I as component};
