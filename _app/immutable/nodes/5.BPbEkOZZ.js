import{s as w,n as u}from"../chunks/scheduler.Cs0xm5t1.js";import{S as H,i as P,e as l,s as h,c as r,a as b,g as f,j as v,l as i,d as n}from"../chunks/index.odHI_-bW.js";function _(y){let a,d,c,p,o,x=`<img src="https://raw.githubusercontent.com/CoCoSol007/hexing/main/logo.png" alt="Logo" class="w-3/4 md:w-1/2 max-w-md"/> <div class="flex flex-col items-center md:items-start text-center md:text-left"><h3 class="text-4xl font-bold mb-4 text-gray-100">Hexing</h3> <p class="text-lg text-gray-300"><i class="italic">&quot;Hexagons are the bestagons&quot;</i> <br/>
            A basic Rust library to manipulate hexagonal grids.</p></div>`,g,t,m=`<p class="mb-4"><code class="code bg-gray-700 p-1 rounded">hexing</code> is a Rust library designed
    ...
    rings and spirals.</p> <p class="mb-4">The link to the <a href="https://docs.rs/hexing/latest/hexing/" class="text-blue-500 hover:underline">docs</a> or the <a href="https://github.com/CoCoSol007/hexing" class="text-blue-500 hover:underline">repository</a>.</p> <h2 class="text-2xl font-semibold mb-2">Features</h2> <ul class="list-disc pl-5 mb-4"><li><strong>Hexagonal Coordinate Manipulation</strong>: Represent and
      ...
      hexagonal positions.</li></ul> <hr class="mb-4 border-gray-700"/> <h2 class="text-2xl font-semibold mb-2">Number Trait</h2> <p class="mb-4">The library uses the <code class="code bg-gray-700 p-1 rounded">Number</code> trait
...
let origin = HexPosition::ORIGIN;</code></pre> <p class="mt-2">Creates a new <a href="https://www.redblobgames.com/grids/hexagons/#coordinates" class="text-blue-500 hover:underline">HexPosition</a>
      ...
      <code class="code bg-gray-700 p-1 rounded">r</code> coordinates in an axial format.</p></div> <div class="rounded mb-4"><h4 class="text-lg font-semibold mb-2">Conversion to Pixel Coordinates:</h4> <pre class="bg-gray-800 rounded my-2 p-2 overflow-x-auto"><code class="code language-rust">let pixel_coords = pos.to_pixel_coordinates();
...
hexing = &quot;0.2.0&quot;</code></pre> <p class="mt-2">Add <code class="code bg-gray-700 p-1 rounded">hexing</code> to your
      <code class="code bg-gray-700 p-1 rounded">Cargo.toml</code>.</p></div>`;return{c(){a=l("br"),d=l("br"),c=l("br"),p=h(),o=l("div"),o.innerHTML=x,g=h(),t=l("main"),t.innerHTML=m,this.h()},l(e){a=r(e,"BR",{}),d=r(e,"BR",{}),c=r(e,"BR",{}),p=b(e),o=r(e,"DIV",{class:!0,"data-svelte-h":!0}),f(o)!=="svelte-1o8rlpx"&&(o.innerHTML=x),g=b(e),t=r(e,"MAIN",{class:!0,"data-svelte-h":!0}),f(t)!=="svelte-2uaupk"&&(t.innerHTML=m),this.h()},h(){v(o,"class","flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-6 px-4 max-w-3xl mx-auto"),v(t,"class","p-6 max-w-3xl mx-auto")},m(e,s){i(e,a,s),i(e,d,s),i(e,c,s),i(e,p,s),i(e,o,s),i(e,g,s),i(e,t,s)},p:u,i:u,o:u,d(e){e&&(n(a),n(d),n(c),n(p),n(o),n(g),n(t))}}}class C extends H{constructor(a){super(),P(this,a,null,_,w,{})}}export{C as component};
