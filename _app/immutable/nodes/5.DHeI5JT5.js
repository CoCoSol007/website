import{t as a,a as t}from"../chunks/disclose-version.Cu-rA40X.js";import"../chunks/legacy.B6avqN4q.js";import{$ as n}from"../chunks/runtime.EAZJyJT1.js";import{h as l}from"../chunks/svelte-head.BjRLNLpX.js";import{a as e}from"../chunks/attributes.CaPm3nup.js";const h=""+new URL("../assets/intro.CSyXUABa.png",import.meta.url).href,c=""+new URL("../assets/rast.BuaQUlGH.png",import.meta.url).href,d=""+new URL("../assets/shad.UmFbctmw.png",import.meta.url).href;var p=a('<meta name="description" content="Learn how 3D rendering works, covering the key steps of Vertex Shading, Rasterisation, and Fragment Shading in the rendering pipeline.">'),m=a(`<main class="p-6 max-w-3xl mx-auto"><h1 class="text-4xl font-bold text-gray-100 my-4">How does a 3D renderer work?</h1> <section class="text-lg text-gray-300 mb-4"><p class="font-semibold">authors : Lucien VILLARD &amp; Corentin SOLOIS</p></section> <h2 id="overview" class="text-2xl font-bold text-gray-100 mb-2">Introduction</h2> <p class="text-lg text-gray-300 mb-1">3D is everywhere in our new technology. Think of film (animation, VFX),
    ...
    this field.</p> <section class="mt-8"><h2 class="text-2xl font-bold text-gray-100 mb-2">Sources</h2> <ul class="text-lg text-gray-300 list-disc ml-6"><li><a href="https://www.youtube.com/watch?v=C8YtdC8mxTU" class="text-blue-500 hover:underline" target="_blank">How do Video Game Graphics Work?</a></li> <li><a href="https://en.wikipedia.org/wiki/Shader#Vertex_shaders" class="text-blue-500 hover:underline" target="_blank">Vertex Shaders</a></li> <li><a href="https://en.wikipedia.org/wiki/Graphics_pipeline" class="text-blue-500 hover:underline" target="_blank">Graphics Pipeline</a></li> <li><a href="https://en.wikipedia.org/wiki/3D_projection" class="text-blue-500 hover:underline" target="_blank">3D projection</a></li> <li><a href="https://en.wikipedia.org/wiki/3D_rendering" class="text-blue-500 hover:underline" target="_blank">3D Rendering</a></li></ul></section></main>`);function b(i){var o=m();l(r=>{var s=p();n.title="How does a 3D renderer work?",t(r,s)}),t(i,o)}export{b as component};
