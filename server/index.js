import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component, n as noop, a as safe_not_equal } from './chunks/ssr-CuYULQwl.js';
...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!doctype html>\n<html lang="en">\n\n<head>\n	<meta charset="utf-8" />\n	<link rel="icon" href="/logo.svg" />\n	<meta name="viewport" content="width=device-width, initial-scale=1" />\n	<meta name="description" content="A great Website for a great Developper">\n	<meta name="keywords" content="Rust, Code, Language, Dev, CoCoSol, Coco, Sol, Python, Programming, graphic design, backend developer">\n	<meta name="author" content="CoCoSol">\n	<meta name="viewport" content="width=device-width, initial-scale=1.0">\n	' + head + `
	<title>CoCoSol</title>
