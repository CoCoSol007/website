  ...
  const articles = [
    {
      ...
      date: "04/22/2024",
      content: `
            <h1 class="text-3xl font-bold text-center mb-4">Welcome to our submission for Godot Wild Jam #68</h1>
            <p class="text-lg text-center mb-6">This month's theme was Forge, inspiring us to create a rhythmic adventure where you craft items from start to finish. You can play our game <a href="https://edmondada.itch.io/beats-into-shapes" class="text-blue-500 hover:underline">here</a>.</p>
        
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 justify-center">
            <h2 class="text-2xl font-bold col-span-full text-center">Meet Our Team</h2>
            ...
            <div class="flex flex-col items-center">
                ...
                <p class="text-gray-600">Programmer - Art</p>
            </div>
            <div class="flex flex-col items-center">
...
`,
    ...
    },
    {
      ...
      content: `<div class="mt-4 text-center">
            ...
            <p class="text-lg mb-4">I'm CoCoSol, a 17-year-old French coder eager to learn. Passionate about development and math, I'm a student at Caousou in France, always up for new challenges.</p>
            <p class="text-lg">To contact me or ask questions, email me at <a href="mailto:contact@cocosol.fr" class="text-blue-500 hover:underline">contact@cocosol.fr</a>.</p>
        </div>
        é`,
