...
<nav class="fixed w-full z-20 top-0 start-0 border-b border-gray-600 backdrop-blur-2xl bg-gray-900/80">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
    ...
    <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse mr-4">
      ...
      <button button-name="navbar-toggle" on:click={() => toggleMenu()} type="button" class="inline-flex items-center m-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-200" aria-controls="navbar-sticky" aria-expanded="false">
...
<footer class="py-4">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center h-full">
        ...
        <div class="text-center">
            <a href="https://creativecommons.org/licenses/by-nc/4.0/deed.fr" target="_blank" rel="noopener noreferrer" class="text-blue-500 hover:underline">Licensed under CC BY-NC 4.0 DEED</a>
        </div>
    </div>
</footer>
