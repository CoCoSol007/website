<svelte:head>
  <title
    >Structured and intuitive introduction to Zermelo-Fraenkel set theory</title
  >
  <meta
    name="description"
...
<main class="p-6 max-w-3xl mx-auto">
  ...
  <p class="text-lg text-gray-300 mb-1 indent-8">
    At the beginning of the 20th century, a number of paradoxes challenged the
  ...
  <p class="text-lg text-gray-300 indent-8">
    Before examining these axioms, it's important to understand the concept of a
  ...
  <p class="text-lg text-gray-300 mt-4 indent-8">
    Finally, a word of clarification: this article uses mathematical and logical
    notations that may seem complex to beginners. However, understanding them is
    optional and won’t prevent you from understanding the core concepts.
  </p>
  ...
  <p class="text-lg text-gray-300 mb-1 indent-8">
    The initial axioms in this list are intuitive and introduce fundamental
  ...
  <p
    class="text-lg text-gray-300 mt-4 font-sans overflow-x-auto whitespace-pre"
  >
    ∀A, ∀B, ∀x( x ∈ A ⇔ x ∈ B ) ⇔ A = B
  </p>

  <p
    class="text-lg text-gray-300 mt-1 font-sans overflow-x-auto whitespace-pre"
  >
    ∀A, ∀B, ∀x( x ∈ A ⇒ x ∈ B ) ⇔ A ⊆ B
  </p>
  ...
  <p class="text-lg text-gray-300 mb-1 indent-8">
    For any set X and any set Y, there necessarily exists a new set Z that
  ...
  <p class="text-lg text-gray-300 mb-1 indent-8">
    There is always a set that contains only the elements of two sets X and Y.
    ...
    containing the entire contents of both.
  </p>
  ...
  <p class="text-lg text-gray-300 mb-1 indent-8">
    For any given set, there exists a larger set that contains only all its
    ...
    second, and so on for all possible combinations.
  </p>
  ...
  <p class="text-lg text-gray-300 mb-1 indent-8">
    There is a set containing an infinite number of elements, which makes it
    ...
    indefinitely, like the sequence of natural numbers (0, 1, 2, 3, ...).
  </p>
  ...
  <p class="text-lg text-gray-300 mb-1 indent-8">
    For any property P, for example “The sock is blue”, there exists a set
    ...
    possible to define sets according to specific characteristics.
  </p>
  ...
  <p class="text-lg text-gray-300 mb-1 indent-8">
    There is one and only one empty set, i.e. a drawer that contains nothing.
    ...
    denoted by the symbol <span class="text-lg font-sans">∅</span>.
  </p>
  ...
  <p class="text-lg text-gray-300 mb-1 indent-8">
    For any set, if one applies a well-defined function (which associates with
    ...
    in a new set, just as defined as the original.
  </p>
  ...
  <p class="text-lg text-gray-300 mb-1 indent-8">
    The foundation axiom aims to avoid paradoxes where a set could refer to
    ...
    cycles or infinite references, thus preserving the logic of sets.
  </p>
  ...
  <p class="text-lg text-gray-300 mb-1 indent-8">
    A large number of propositions can be demonstrated using the nine axioms
  ...
  <ul class="list-disc list-inside space-y-1">
    ...
    <li>
      The set <span class="font-sans">&#123;a&#125;</span> is a subset of
      <span class="font-sans">&#123;a, b&#125;</span>.
    </li>
    <li>The intersection of two disjoint sets is empty.</li>
    <li>
      If <span class="italic">A ⊆ B</span> and
      <span class="italic">B ⊆ C</span>, then <span class="italic">A ⊆ C</span>.
    </li>
    <li>The set of natural numbers is an infinite set.</li>
    <li>
      The set <span class="font-sans">∅ ∪ A = A</span> and the set
      <span class="font-sans">∅ ∩ A = ∅</span>.
    </li>
  </ul>
</main>
