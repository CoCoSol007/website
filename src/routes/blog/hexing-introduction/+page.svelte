<svelte:head>
  <title>Hexing: Rust Library for Hexagonal Grid Manipulation</title>
  <meta
    name="description"
    content="Hexing is a basic Rust library designed to manipulate hexagonal grids, offering features such as distance calculations, pixel coordinate conversion, and more."
  />
</svelte:head>

<div
  class="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-6 px-4 mt-8 max-w-3xl mx-auto"
>
  <img
    src="https://raw.githubusercontent.com/CoCoSol007/hexing/main/logo.png"
    alt="Logo"
    class="w-3/4 md:w-1/2 max-w-md"
  />
  <div
  ...
  >
    ...
    <p class="text-lg text-gray-300">
      <i class="italic">"Hexagons are the bestagons"</i>
      <br />
...
<main class="p-6 max-w-3xl mx-auto">
  ...
  <p class="mb-4">
    The link to the <a
      href="https://docs.rs/hexing/latest/hexing/"
      class="text-blue-500 hover:underline">docs</a
    >
    or the
    <a
      href="https://github.com/CoCoSol007/hexing"
  ...
  <ul class="list-disc pl-5 mb-4">
    <li>
      <strong>Hexagonal Coordinate Manipulation</strong>: Represent and
      manipulate positions in a hexagonal grid using axial coordinates.
    </li>
    <li>
      <strong>Distance Calculations</strong>: Compute the distance between two
      hexagonal positions.
    </li>
    <li>
      <strong>Pixel Coordinate Conversion</strong>: Convert hexagonal positions
      to pixel coordinates for graphical use.
    </li>
    <li>
      <strong>Reflection and Rotation</strong>: Apply reflection and rotation to
      hexagonal positions.
    </li>
    <li>
      <strong>Ring and Spiral Iterators</strong>: Obtain positions in a ring or
      spiral around a central position.
    </li>
    <li>
      <strong>Line Iterators</strong>: Obtain positions along a line between two
      hexagonal positions.
    </li>
  </ul>
  ...
  <h3 class="text-xl font-semibold mb-2" id="HexPosition">
    HexPosition&lt;T&gt;
  </h3>
  <p class="mb-4">
...
let origin = HexPosition::ORIGIN;</code
      ></pre>
    <p class="mt-2">
      Creates a new <a
...
let pixel_coords2 = HexPosition::from_pixel_coordinates(pixel_coords);</code
      ></pre>
    <p class="mt-2">
      Converts the current <a
        href="#HexPosition"
        class="text-blue-500 hover:underline">HexPosition</a
      > into a pixel coordinate. Basically, it converts a position in a hexagonal
      grid to a position in an orthogonal grid.
    </p>
  </div>
  ...
  <div class="  rounded mb-4">
    ...
    <pre class="bg-gray-800 rounded my-2 p-2 overflow-x-auto"><code
      ...
      ></pre>
    <p class="mt-2">
      Calculates the distance between two hexagonal positions, using the <a
        href="https://en.wikipedia.org/wiki/Taxicab_geometry"
        class="text-blue-500 hover:underline">Manhattan distance</a
      >.
    </p>
  </div>
  ...
  <div class="  rounded mb-4">
    ...
    <pre class="bg-gray-800 rounded my-2 p-2 overflow-x-auto"><code
        class="code language-rust">let rotated_pos = pos.rotation(2);</code
      ></pre>
    <p class="mt-2">
  ...
  <div class="  rounded mb-4">
    ...
    <pre class="bg-gray-800 rounded my-2 p-2 overflow-x-auto"><code
        class="code language-rust">let reflected_pos = pos.reflect();</code
      ></pre>
    <p class="mt-2">
  ...
  <div class="  rounded mb-4">
    ...
    println!("&#123;:?}", ring_pos);
      ...
      ></pre>
    <p class="mt-2">
      An iterator that returns positions in a ring around a central position.
      The iterator will return positions in a ring with the given radius.
    </p>
  </div>
  ...
  <div class="  rounded mb-4">
    ...
    println!("&#123;:?}", spiral_pos);
      ...
      ></pre>
    <p class="mt-2">
      An iterator that returns positions in a spiral around a central position.
      The iterator will return positions in a spiral with the given radius.
    </p>
  </div>
...
for line_pos in a.line(b) &#123;
    println!("&#123;:?}", line_pos);
      ...
      ></pre>
    <p class="mt-2">
      An iterator that returns positions along a line between two hexagonal
      positions.
    </p>
  </div>
...
let vector = direction.to_vector();</code
    ...
    <p class="mt-2">
      You can convert a <a
        href="#HexDirection"
        class="text-blue-500 hover:underline">HexDirection</a
      >
      to a
...
assert!(position == new_position);</code
    ></pre>
...
println!("Rotated Position: &#123;:?}", rotated_pos);</code
    ></pre>
...
println!("Reflected Position: &#123;:?}", reflected_pos);</code
    ></pre>
...
println!("New Position after moving Right: &#123;:?}", new_position);</code
    ></pre>

  <hr class="mb-4 border-gray-700" />

  <h2 class="text-2xl font-semibold mb-2">Full Documentation</h2>
  <p class="mb-4">
    For more detailed documentation and additional explanations about hexagonal
    grids, please refer to the <a
      href="https://www.redblobgames.com/grids/hexagons/"
      class="text-blue-500 hover:underline"
      >Red Blob Games hexagonal grid documentation</a
    >.
  </p>
