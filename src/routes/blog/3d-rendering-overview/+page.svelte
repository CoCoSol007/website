...
<svelte:head>
  <title>How does a 3D renderer work?</title>
  <meta
    name="description"
    content="Learn how 3D rendering works, covering the key steps of Vertex Shading, Rasterisation, and Fragment Shading in the rendering pipeline."
  />
</svelte:head>
...
<main class="p-6 max-w-3xl mx-auto">
  ...
  <h2 id="overview" class="text-2xl font-bold text-gray-100 mb-2">
    Introduction
  </h2>
  <p class="text-lg text-gray-300 mb-1">
    3D is everywhere in our new technology. Think of film (animation, VFX),
    ...
    understand the basis of the 3D renderer.
  </p>
  <img src={intro} alt="intro" class="w-full" />

  <h2 id="overview" class="text-2xl font-bold text-gray-100 mb-2 mt-8">
    Vertex Shading
  </h2>
  <p class="text-lg text-gray-300 mb-1">
    First of all, it is very important to understand how 3D models are
    ...
    position is projected onto the 2D screen.
  </p>
  ...
  <p class="text-lg text-gray-300 mb-1">
    To continue, just remember that a screen is a grid of millions of pixels of
  ...
  <img src={rast} alt="Rasterisation" class="w-full" />

  <h2 id="overview" class="text-2xl font-bold text-gray-100 mb-2 mt-8">
    Fragment Shading
  </h2>
  <p class="text-lg text-gray-300 mb-1">
    After the first two steps, we get a passable rendering, but there's no
    ...
    depending on its color, roughness (gloss) or refractive index.
  </p>
  <img src={shad} alt="Fragment Shading" class="w-full" />

  <h2 id="overview" class="text-2xl font-bold text-gray-100 mb-2 mt-8">
    Conclusion
  </h2>
  <p class="text-lg text-gray-300 mb-1">
    This article is just an overview of the world of 3D rendering engines. We
