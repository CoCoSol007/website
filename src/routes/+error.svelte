<script>
  import { page } from '$app/stores'; // Assurez-vous que cette importation est correcte et que le magasin existe
</script>

<div class="min-h-screen flex items-center justify-center">
  <div class="max-w-2xl bg-gradient-to-br from-blue-950 to-gray-900 p-8 rounded-lg shadow-lg text-center text-white">
